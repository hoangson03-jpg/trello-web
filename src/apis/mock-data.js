// Lên github của TrungQuanDev-public-utilities-algorithms để cài mock data về
/**
...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Snobby MERN Stack Board',
    description: 'TrungQuanDev Pro MERN stack Course',
    type: 'public', // 'private'
    ownerIds: [], // Những users là Admin của board admin có thể là nhiều
        ...
        cards: [
          {
            ...
            cover: 'https://statics.cdn.200lab.io/2023/04/Python-la-gi.png',
